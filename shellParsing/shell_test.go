...
func TestParseMinerInfo(t *testing.T) {
	...
	tJobs := jobs.(map[string]interface{})
	tHardware := hardwareInfo.(map[string]interface{})
	result := ParseJobsInfo(tJobs, tHardware)
